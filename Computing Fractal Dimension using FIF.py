# -*- coding: utf-8 -*-
"""Computing Fractal Dimension using FIF 1.0.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1plNNhgVvOycUjxtfweycWDPPotaC9lVO
...
plotGraphKsa(ksaEast, 'KSA East')

plotGraphKsa(ksaWest, 'KSA WEST')

# plotGraphKsaComb(ksaEast, ksaWest)
...
for i in range(len(eastAndWestList)):
  ...
  # print((i, d ) if d > 1.15 else None)

average = summ/(len(eastAndWestList))
